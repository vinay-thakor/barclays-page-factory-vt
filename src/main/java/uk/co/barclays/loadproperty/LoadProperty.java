...
public class LoadProperty {
    ...
    public String getProperty(String key) {
        ...
        try {
            input = new FileInputStream(projectPath + "/src/test/java/uk/co/barclays/resources/properties/config.properties");
    ...
    //can write a main method here to only check the working of the the above code
    // written in "getProperty()"
